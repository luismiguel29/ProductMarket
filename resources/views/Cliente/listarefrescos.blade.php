...
<body class="d-flex flex-column">
    <header>
        <!--<img src="{{ asset('storage/imagenes/leche.png') }}" width="80px" alt="Logo de ProductMarket">-->
        <div class="pos-f-t">
    ...
    <header class="bann">
        <div class="logo">
            <img src="{{$categoryName->url}}" width="70px">
            <h2 class="nombreCat">
                {{$categoryName->nombre}}
            </h2>
        ...
        <div class="col" >
            ...
            <div class="card-footer overflow-hidden" style="background-color: #FFD507">
                @if ($producto->preciodesc>0)
                    <span>Bs  <del>{{$producto->preciodesc}}</del> /</span>
