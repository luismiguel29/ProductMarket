    ...
    <div class="d-flex justify-content-around" style="padding-top: 52px;">
        ...
        <div class="card mb-5" style="width: 25rem;">
            ...
            <div class="card-body text-dark card-custom-p">
                ...
                <form action="{{ route('registrarUser') }}" method="post" class="row g-3" id="formulario"
                    ...
                    <div class="col-12">
                        ...
                        <input type="email" name="email" class="form-control" id="" value="{{ old('email') }}" 
                            required  pattern=".+@gmail\.com" minlength="4" maxlength="30" title="El correo electronico debe tener la extension gmail.com. Letras mayuculas, minuscula y numeros"
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input ID="txtPassword" type="Password" Class="form-control" name="password" required minlength="6" maxlength="20"
                                onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                <input ID="txtPasswordrep" type="Password" Class="form-control" name="passwordrep" required minlength="6" maxlength="20"
                                onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                                <span class="input-group-btn">
                                    <button id="show_passwordrep" class="btn btn-secondary" type="button" onclick="mostrarPasswordrep()">
