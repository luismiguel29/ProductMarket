...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarRR"
    ...
    <div class="offcanvas-body">
                    ...
                    <div class="d-flex justify-content-center row g-0">
                        ...
                        <div class="col-md-4 align-self-center">
                            <div class="d-flex justify-content-around">
                                <a href="/decrementar/{{$item->idcarrito}}" class="fa-solid fa-square-minus fa-2x" style="text-decoration: none;color:black"></a>
                                <span style="font-size:20px">{{$item ->cantidad}}</span>
                                <a href="/incrementar/{{$item->idcarrito}}" class="fa-solid fa-square-plus fa-2x" style="text-decoration: none;color:black"></a>
                                
                                
                                <form action="{{route('carrito.destroy', $item->idcarrito)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="fa-solid fa-trash fa-2x" value="Eliminar" style="border:none"> </button>
                                </form> 
        ...
        <div class="botonCompra">
            <button type="submit" class="btn btn-dark fs-5 {{-- btn-block --}}" style="width: 300px" style="font-size: 60px" --}}>Finalizar Compra</button>
        </div>
    </div>
